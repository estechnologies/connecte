...
<html lang="en">
<head>
 <title>Recruiter Edit Posting</title>
  <meta charset="utf-8">
...
<div class="col-md-6">
  ...
  <center>  <div style="background-color: #eee;color:black;" class="panel-heading"><h3 class="panel-title"><strong>Edit posting</strong></h3>
  ...
  <div style="margin-bottom: 12px" class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
             <input type="text" name="Landlinenumber" id="Landlinenumber" placeholder="Enter Landline number" maxlength="15"  class="form-control"  value="">                                       
                                     ...
                                     <center><button type="submit" name="submit" id="submit" class="btn btn-default"><span class="glyphicon glyphicon-log-in"></span> &nbsp Edit Post Job</button></center>
