 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  ...
  <img src="images/logo.gif" class="logo"></img>
	...
	<section id="Registration-page">
         <div class="container" style="margin-top:20px;margin-bottom:23px;">
    <div class="row">
         <div class="col-md-6 col-md-offset-3">
         <div class="panel panel-default">
  <center>   <div style="background-color:#eee;margin-bottom:10px;" class="panel-heading"><h3 class="panel-title"><strong>Recruiter Registration</strong></h3> </center> 
  
  <div class="panel-body">
                     <form id="login-form" action="Sign_In.html" method="post" role="form">
                     <center><?php 
   ...
   <center class="message"> <label style="font-size: 14px;color:green;"><?php echo $msg1;?></label></center>
		 ...
		 <?php	
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                            <input type="text" name="companyname" id="companyname" maxlength="50" minlength="4" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" required="required" tabindex="1" class="form-control" placeholder="Enter companyname" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
