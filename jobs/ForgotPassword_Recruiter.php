...
<link href="css/job.css"rel="stylesheet"/>
	...
	<div id="breadcrumb" >
		<div class="container">	
			<div class="breadcrumb">							
				...
				<li>Recruiter Forgot Password</li>			
			</div>		
		</div>	
	</div>
  ...
  <center>   <div style="background-color:#eee;margin-bottom:10px;" class="panel-heading"><h3 class="panel-title"><strong>Recruiter Forgot Password</strong></h3> </center> 
