...
<head>
 <title>Admin Login</title>
  ...
  <img class="logo" src="images/logo.gif"></img>
	...
	<div class="container" id="mainborder" style="margin-top:175px;margin-bottom:174px;">
<div class="col-md-3">
</div>

<div class="col-md-6">
    <div class="panel panel-default">
  <center>  <div style="background-color: #eee;color:black;" class="panel-heading"><h3 class="panel-title"><strong>Admin Login</strong></h3>
