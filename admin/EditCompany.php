<?php 
	...
	if(isset($_GET['cmp'])){
		...
		$cmpid = htmlspecialchars($_GET['cmp']);
		$query = "SELECT * FROM company WHERE cmpId='$cmpid'";
		$resultQuery = mysql_query($query);
		
		if(mysql_num_rows($resultQuery) <= 0){
			echo "<script>alert('no company id found');</script>"; 
		}else{
...
<div class="col-md-6">
  ...
  <center>  <div style="background-color: #eee;color:black;" class="panel-heading"><h3 class="panel-title"><strong>Edit Company</strong></h3>
...
<form id="Employee-form" action="companyEditBack.php" method="POST" role="form" style="display: block;">
			
 
								  <label for="CompanyName">Company Name*</label>
                            <div style="margin-bottom: 12px" class="input-group">
                            <input type="hidden" name="cmpId" id="cmpId" value="<?php echo $row['cmpId']; ?>" />
                                         <span class="input-group-addon"><i class="glyphicon glyphicon-equalizer"></i></span>
                                       <input  type="text"  id="CompanyName" name="CompanyName"  value ="<?php echo $row['name'];?>" oninvalid="InvalidMsgError(this);" required="required"  oninput="InvalidMsgError(this); "  placeholder="Enter Company name" maxlength="50"  class="form-control" />
                                        </div>
									<label for="CompanyCode">Company Code*</label>
                            <div style="margin-bottom: 12px" class="input-group">
                                         <span class="input-group-addon"><i class="glyphicon glyphicon-equalizer"></i></span>
                                       <input  type="text"   id="CompanyCode" name="CompanyCode" oninvalid="InvalidMsgError(this);" value ="<?php echo $row['code'];?>" required="required"  oninput="InvalidMsgError(this); "  placeholder="Enter Company code" maxlength="10"  class="form-control" />
                                  </div>
                                 			<label for="CompanyType">Company Type*</label>
                            <div style="margin-bottom: 12px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-equalizer"></i></span>
                                       <input  type="text"   id="CompanyType" name="CompanyType" oninvalid="InvalidMsgError(this);" value ="<?php echo $row['type'];?>" required="required"  oninput="InvalidMsgError(this); "  placeholder="Enter Company type" maxlength="50"  class="form-control" />
                                  </div>
								  <label for="CompanyAddress">Company Address*</label>
                            <div style="margin-bottom: 12px" class="input-group">
                                         <span class="input-group-addon"><i class="glyphicon glyphicon-map-marker"></i></span>
                                       <textarea  type="text"  id="CompanyAddress" name="CompanyAddress" oninvalid="InvalidMsgError(this);" required="required"  oninput="InvalidMsgError(this); "  placeholder="Enter Company Address" maxlength="200"  class="form-control" ><?php echo $row['address'];?></textarea>
                                  </div>
  ...
  <div style="margin-bottom: 12px"  class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
             <input type="text" name="CompanyPhonenumber" id="CompanyPhonenumber" maxlength="15" oninvalid="InvalidMsgErrorphone(this);" value ="<?php echo $row['number'];?>" oninput="InvalidMsgErrorphone(this);" required="required" class="form-control" minlength="9" placeholder="Enter Company Phone number" value="">                                       
  </div>
</div>
                                  	 <label for="Contactpersonname">Contact Person name*</label>
  <div style="margin-bottom: 12px" class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		<input type="text" name="Contactpersonname" id="Contactpersonname"  value ="<?php echo $row['personname'];?>" maxlength="50" minlength="4" oninvalid="InvalidMsglength(this);"  oninput="InvalidMsglength(this);" required="required" tabindex="1" class="form-control" placeholder="Enter Contact Person name" value="">
	</div>
  ...
  <div style="margin-bottom: 12px" class="input-group">
		...
		<input  name= "ContactpersonEmailaddress" id="ContactpersonEmailaddress" value ="<?php echo $row['personemail'];?>" onfocusout="checkEmail()" maxlength="50"  class="form-control" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" oninvalid="InvalidMsgEmail(this);"  oninput="InvalidMsgEmail(this); " type="text" class="form-control"  placeholder="Enter contact person email address">                                     
  </div>
	<label for="ContactpersonMobilenumber">Contact Person Mobile number*</label>
  <div style="margin-bottom: 12px" class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
             <input type="text" name="ContactpersonMobilenumber" id="ContactpersonMobilenumber"  value ="<?php echo $row['personnumber'];?>" oninvalid="InvalidMsg(this);" maxlength="10" oninput="InvalidMsg(this);" required="required" class="form-control" pattern="[0-9]{10}" placeholder="Enter contact person phone number" >                                       
  ...
  <div style="margin-bottom: 12px" id="maximumemployee" class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		<input type="text" name="Maximumnoofemployees" id="Maximumnoofemployees" value ="<?php echo $row['numberUsers'];?>" maxlength="5" onfocusout="noofuserzero()" oninvalid="InvalidMsgError(this);"  oninput="InvalidMsgError(this);" required="required" tabindex="1" class="form-control" placeholder="Enter maximum number of users" >
	</div>	<center> <p style="color:red" id="msgaccess"></p></center>		
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
		<div class="input-group date form_date " data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
										<input class="widthdate form-control" style="background-color: white;"  type="text" oninvalid="InvalidMsgsdate(this);"  oninput="InvalidMsgsdate(this);"   required="required" placeholder="Select date" name="Access" id="Access"  value ="<?php echo $row['accessyear'];?>"  size="16" >
  ...
  <div style="margin-bottom: 12px" id="maximumemployee" class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		<input type="text" name="Amount" id="Amount" maxlength="5" onfocusout="amountzero()" oninvalid="InvalidMsgError(this);"  oninput="InvalidMsgError(this);" required="required" tabindex="1" class="form-control" placeholder="Enter Amount"  value ="<?php echo $row['amount'];?>" >
	</div>	
	<center><p style="color: red;" id="msgUsername" name="msgUsername" ></p></center>
	<label for="Username">Admin Username*</label>
  <div style="margin-bottom: 12px" class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		<input type="text" name="AdminUsername" id="AdminUsername" maxlength="50" minlength="4" value ="<?php echo $row['username'];?>"  onfocusout="checkUsername()"  oninvalid="InvalidMsgError(this);"  oninput="InvalidMsgError(this);" required="required" tabindex="1" class="form-control" placeholder="Enter Admin username" value="">
	</div>
                                    <center><button type="submit" name="login-submit" id="login-submit"  class="btn btn-default">Update Company</button></center>
									...
									function checkUsername(){
										...
										var cmpId = $('#cmpId').val();
										$.post('checkUsernameBack.php',{username:username,cmpId:cmpId},function(data){
									...
									function checkEmail(){
										...
										$.post('checkUsernameBack.php',{email:email,cmpId:cmpId},function(data){
